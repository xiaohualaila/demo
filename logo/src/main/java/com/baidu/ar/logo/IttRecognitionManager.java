...
public class IttRecognitionManager {
     ...
     */
    public void init(Context context, IttRecognitionCallback callback) {
        mContext = context;
    ...
    public void setYUVFile(byte[] yuvdata, int pWidth, int pHeight) {
        ...
        try {
            ...
            rgbBuf = new WeakReference<>(originalRgbBuf);
            ...
            bitmap = new WeakReference<>(originalBitmap);
            ...
            HttpTaskUtility.addBasicInfo(mContext, params);
