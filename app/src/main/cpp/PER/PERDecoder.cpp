...
bool PERDecoder::isIFrame(uchar *data) {
    LOGI("PERDec:isIFrame data[0]:%d ", data[0]);
    LOGI("PERDec:isIFrame data[1]:%d ", data[1]);
    LOGI("PERDec:isIFrame data[2]:%d ", data[2]);
    LOGI("PERDec:isIFrame data[3]:%d ", data[3]);
    LOGI("PERDec:isIFrame data[4]:%d ", data[4]);//103//79
