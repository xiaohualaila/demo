...
LONG WINAPI PE_Client_RealPlay(LONG lUserID, LPPE_CLIENT_PREVIEWINFO lpPreviewInfo, fPERealDataCallBack cbRealDataCallBack, void* pUserData)
{
    ...
    if (lpPreviewInfo->byProtoType == 0 && lpPreviewInfo->dwLinkMode == 0)
    {
        ...
        int handle;
//        int port = lppe_client->lpclient->GetStreamPort(sadp_info.sUUID);
////        LOGI("PEClientSDK: 端口号 %d:\n", port);//5607
//
////        getStreamClient = new CClient();
////        getStreamClient->ClientAlloc();
//        if (!lppe_client->lpclient->->Connect(addressbuf, port, false))
//        {
//            lppe_client->lpclient->->ClientRelease();
//            delete lppe_client->lpclient->;
//            lppe_client->lpclient-> = nullptr;
//            //return;
//        }
//        if (0 != lppe_client->lpclient->->Login(UserNamebuf, Passwordbuf))
//        {
//            lppe_client->lpclient->->ClientRelease();
//            delete lppe_client->lpclient->;
//            lppe_client->lpclient-> = nullptr;
